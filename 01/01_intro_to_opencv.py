...
Original file is located at
    https://colab.research.google.com/drive/1KhxwC5F2i6NzkTy6KNGKaAPsdA2YVpGT

#Basics of OpenCV

# <font color="white">📸 Image Processing with OpenCV</font>
...
[![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1KhxwC5F2i6NzkTy6KNGKaAPsdA2YVpGT?usp=sharing)

---

Welcome to your hands-on journey into **Image Processing** and **Computer Vision** using **OpenCV**.  
This notebook is designed to be **simple**, **visual**, and **practical**, guiding you through how digital images are read, visualized, and manipulated with Python.

> 🔗 **Before you start**, make sure you're comfortable with the basics of:
> - [NumPy](https://github.com/Adityeah18/numpy) – for image array manipulation
> - [Matplotlib](https://github.com/Adityeah18/matplotlib) – for visualizing images and data

---

## 📚 Here's What You'll Explore

- 📥 **Loading images** from files into memory  
- 🧾 **Inspecting image properties** like dimensions, channels, and data types  
- 🔢 **Visualizing images as NumPy arrays** – the numerical backbone of OpenCV  
- 🎨 **Handling color channels** — splitting and combining RGB or HSV components  
- 🖼️ **Displaying images** effectively using `matplotlib`  
- 💾 **Saving modified images** back to your system
